...
Item {
  ...
  readonly property variant setupTextA: [fxText[primaryFxUnitProp.value - 1], buttonText1a[leftSide], buttonText2a[leftSide], buttonText3a[leftSide], buttonText4a[leftSide], buttonText5a[leftSide], buttonText6a[leftSide], buttonText7a[leftSide], buttonText8a[leftSide], buttonText9a[leftSide], buttonText10a[leftSide], buttonText11a[leftSide], buttonText12a[leftSide]]
  readonly property variant setupTextB: [fxText[primaryFxUnitProp.value - 1], buttonText1b[leftSide], buttonText2b[leftSide], buttonText3b[leftSide], buttonText4b[leftSide], buttonText5b[leftSide], buttonText6b[leftSide], buttonText7b[leftSide], buttonText8b[leftSide], buttonText9b[leftSide], buttonText10b[leftSide], buttonText11b[leftSide], buttonText12b[leftSide]]
  ...
  readonly property variant buttonText9a: ["", ""]
  readonly property variant buttonText9b: ["", ""]
  readonly property variant buttonText10a: ["", ""]
  readonly property variant buttonText10b: ["", ""]
  readonly property variant buttonText11a: ["", ""]
  readonly property variant buttonText11b: ["", ""]
  readonly property variant buttonText12a: ["", "Cue And"]
  readonly property variant buttonText12b: ["", "Play"]
